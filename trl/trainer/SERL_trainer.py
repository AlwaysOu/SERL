...
class SERLTrainer(Trainer):
    ...
    def _get_train_sampler(self) -> Sampler:
        ...
        #  grad_accum    ▲  ▲  0          0     0   0   1   1 num_generations  2   2   <- Generate for the first `steps_per_generation` (prompts 0 to 11); store the completions; use the first slice to compute the loss
